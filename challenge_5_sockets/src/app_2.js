...
socketServer.on('connection', (socket) => {
    ...
    socket.emit('server:initialProducts', products);
    ...
    socket.on('client:newProduct', async (product) => {
        ...
        let result = await productManagerInstance.addProduct(product)
        console.log({result})
        let newProductList = await productManagerInstance.getProducts();
        //console.log({newProductList});
        socketServer.emit('server:newArrayProducts', newProductList)
